// canvas animation from github.com/kennethnym/infinifi/blob/main/web/bg.js ❤️
...
if (window.matchMedia) {
    ...
    // MutationObserver watching changes to the data-bs-theme attribute
    const observer = new MutationObserver((mutations) => {
        mutations.forEach((mutation) => {
            if (mutation.attributeName === "data-bs-theme") {
                dotColor = (body.getAttribute("data-bs-theme") === "light") ? DOT_COLOR_LIGHT_MODE : DOT_COLOR_DARK_MODE;
                drawPattern();
            }
        });
    });
